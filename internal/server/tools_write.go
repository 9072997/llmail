...
func (s *Server) registerWriteTools() {
	s.mcp.AddTool(
		mcp.NewTool("move_messages",
			...
			mcp.WithArray("uids", mcp.Required(), mcp.Description("Message UIDs to move")),
	...
	s.mcp.AddTool(
		mcp.NewTool("copy_messages",
			...
			mcp.WithString("account", mcp.Required(), mcp.Description("Account name")),
			mcp.WithString("folder", mcp.Required(), mcp.Description("Source folder")),
			mcp.WithArray("uids", mcp.Required(), mcp.Description("Message UIDs to copy")),
			mcp.WithString("dest_folder", mcp.Required(), mcp.Description("Destination folder")),
			mcp.WithToolAnnotation(mcp.ToolAnnotation{
				Title:        "Copy Messages",
				ReadOnlyHint: mcp.ToBoolPtr(false),
	...
	s.mcp.AddTool(
		mcp.NewTool("delete_messages",
			...
			mcp.WithArray("uids", mcp.Required(), mcp.Description("Message UIDs to delete")),
			mcp.WithToolAnnotation(mcp.ToolAnnotation{
	...
	s.mcp.AddTool(
		mcp.NewTool("set_flags",
			...
			mcp.WithArray("uids", mcp.Required(), mcp.Description("Message UIDs")),
			mcp.WithArray("add", mcp.Description("Flags to add")),
			mcp.WithArray("remove", mcp.Description("Flags to remove")),
			mcp.WithToolAnnotation(mcp.ToolAnnotation{
				Title:        "Set Flags",
				ReadOnlyHint: mcp.ToBoolPtr(false),
			}),
	...
	s.mcp.AddTool(
		mcp.NewTool("edit_message",
			...
			mcp.WithArray("to", mcp.Description("New To addresses (replaces all)")),
			mcp.WithArray("cc", mcp.Description("New CC addresses (replaces all)")),
	...
	s.mcp.AddTool(
		mcp.NewTool("unsubscribe",
			...
			mcp.WithString("account", mcp.Required(), mcp.Description("Account name")),
			mcp.WithString("folder", mcp.Required(), mcp.Description("Folder containing the messages")),
			mcp.WithArray("uids", mcp.Required(), mcp.Description("Message UIDs to unsubscribe from")),
			mcp.WithToolAnnotation(mcp.ToolAnnotation{
				Title:        "Unsubscribe",
				ReadOnlyHint: mcp.ToBoolPtr(false),
			}),
	...
	s.mcp.AddTool(
		mcp.NewTool("create_draft",
			...
			mcp.WithArray("to", mcp.Description("To addresses"), mcp.Required()),
			mcp.WithArray("cc", mcp.Description("CC addresses")),
			...
			mcp.WithArray("flags", mcp.Description("Message flags (default: \\Draft)")),
