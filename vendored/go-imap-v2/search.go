...
type SearchCriteria struct {
	...
	// RawKeys are raw IMAP search key strings emitted as-is into the
	// SEARCH command. This enables extensions like Gmail's X-GM-RAW and
	// allows passing arbitrary RFC 9051 search keys.
	RawKeys []string
}
...
func (criteria *SearchCriteria) And(other *SearchCriteria) {
	...
	criteria.RawKeys = append(criteria.RawKeys, other.RawKeys...)
}
